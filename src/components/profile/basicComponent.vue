            ...
            <div class="col-12 order-xs-last">
              ...
              <div class="row">
                <div class="item_form col-12 col-md-4 q-px-lg q-mb-md">
                  <q-field :error="$v.form.first_name.$error" error-label="This field is required">
                    <q-input type="text" v-model="form.first_name" float-label="First Name:"/>
                  </q-field>
                </div>
                <div class="item_form col-12 col-md-4 q-px-lg q-mb-md">
                  <q-field :error="$v.form.last_name.$error" error-label="This field is required">
                    <q-input v-model="form.last_name" float-label="Last Name:"/>
                  </q-field>
                </div>
                <div class="item_form col-12 col-md-4 q-px-lg q-mb-md">
                  <q-field :error="$v.form.email.$error" error-label="Email format invalid">
              ...
              <div class="row">
                <div class="item_form q-px-lg q-mx-auto q-mb-lg text-center col-12 relative-position">
                  ...
                  <div id="contUploadImage">
                    <q-uploader url="" inverted hide-upload-button @add="getSignedUrl" color="primary" extensions=".jpg" float-label="Change Photography"/>
                  </div>
                </div>
                <div class="item_form col-12 q-mb-md">
                  <div class="row">
                    <div class="item_form col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field
                        ...
                        <q-input type="text" :maxlength="14" v-model="profile.telefono" float-label="Telephone" @input="profile.telefono = maskPhone(profile.telefono)"/>
                      </q-field>
                    </div>
                    <div class="item_form col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field icon="phone" icon-color="primary">
                        <q-input type="text" v-model="profile.ext_number" float-label="Extension Number"/>
                      </q-field>
                    </div>
                    <div class="col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field icon="cake" icon-color="primary">
                        <q-datetime class="no-shadow" v-model="profile.birthday" float-label="Birthday" format="YYYY/MM/DD" clearable>
                        </q-datetime>
                      </q-field>
                    </div>
                    <div class="item_form col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field icon="chrome_reader_mode" icon-color="primary">
                        <q-input type="text" v-model="profile.identification" float-label="Identification"/>
                      </q-field>
                    </div>
                    <div class="col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field icon="person_pin_circle" icon-color="primary">
                        <q-input type="text" v-model="profile.address" float-label="Address"/>
                      </q-field>
                    </div>
                    <div class="col-12 col-md-4 q-px-lg q-mb-xl">
                      <q-field icon="location_city" icon-color="primary">
                  ...
                  <div class="row">
                    <div class="col-12 q-px-lg">
                      <div class="form-title q-title">
                        Social Networks
                        <q-btn round flat class="" icon="add" color="primary" @click="addSocial()" size="sm"/>
                      </div>
                      <div class="col-12" style="overflow-x: scroll">
                        <table class="q-table">
                          ...
                          <tr v-for="(item, index) in profile.social" :key="'row_social_'+index">
                                ...
                                <q-btn-dropdown
                                  ...
                                  <q-list link v-for="(red,indexTwo) in redes" :key="indexTwo">
                                    <q-item>
                                      <q-item-main>
                                        <q-item-tile label>
                                        	<a @click="addLabelAndColor(index,red.label,red.color)" title="Twitter" data-toggle="tooltip" data-id="fa-twitter" class="btn social-link btn-twitter" data-placement="right">
                                          {{red.label}}
                                        </a>
                                        </q-item-tile>
                                      </q-item-main>
                            ...
                            <td>
                              <q-field>
                                <q-input type="text" v-model="item.desc" placeholder="@myaccount or /myaccount"/>
                              </q-field>
                            </td>
                            <td>
                              <q-btn round class="" icon="delete" color="primary" @click="removeSocial(index)" size="sm"/>
                            </td>
                          </tr>
                          </tbody>
                        </table>
...
<script>
  /*Services*/
  import authService from '@imagina/quser/_services/auth';
  import profileService from '@imagina/quser/_services/profile';
