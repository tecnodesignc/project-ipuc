		...
		<q-list no-border inset-delimiter>
			...
			<q-item class="q-py-none ">
				<div class="full-width text-primary">
					<q-icon name="fas fa-user-circle" class="q-mr-sm"></q-icon>Role
			...
			<q-item class="q-py-none relative-position">
				<div class="full-width q-mt-sm text-primary">
					<q-icon name="fas fa-globe" class="q-mr-sm"></q-icon>Department
					<treeselect
						:clearable="false"
						:append-to-body="true"
			...
			<!--refresh app-->
			<q-item tag="label" link :to="{name:'app.config'}">
				<q-item-side>
			...
			<div class="fixed fixed-bottom text-teal q-px-md q-py-sm text-right">
