                        ...
                        <div class="col-12">
                            <div class="row content-end">
                                <div class=" text-center col-12 col-md-6 ">
                                    <img v-if="fields.mainImage.value==''"
                                         :src="getImageUrl('/modules/iprofile/img/default.jpg')" alt=""
                                    ...
                                    <div class="row gutter-xs q-pa-sm">
                                        ...
                                        <div class="item-form col-12">
                                            ...
                                            >
                                                <q-input v-model="form.lastName"
                                                         clearable float-label="Apellidos *:"
                                                />
                                            </q-field>
                                        </div>
                                        <div class="item-form col-12">
                                        ...
                                        <div class="item-form col-12">
                                            <q-field
                                                    ...
                                                    error-label="Correo Electronico Invalido"
                                                    icon-color="primary"
                                        ...
                                        <div class="col-12">
                                            ...
                                            >
                                                <q-datetime class="no-shadow"
                                                            ...
                                                            float-label="Fecha de Nacimineto"
                                                            format="MM/DD/YYYY"
                                                            clearable>
                                                </q-datetime>
                                            </q-field>
                    ...
                    <div class="row gutter-xs q-px-sm">
                        <div class="col-12">
                            <q-tabs animated swipeable inverted color="secondary" align="justify">
                                <q-tab default name="fields" slot="title" label="Adicionales"/>
                                <q-tab default name="address" slot="title" label="Direcciones"/>
                                <q-tab name="contacts" slot="title" label="Contacto"/>
                                <q-tab name="socials" slot="title" label="Redes Sociales"/>
                                <!--<q-tab-pane keep-alive name="fields">
                                    <div class="row gutter-sm">
                                        <div class="col-12 col-md-6">
                                            <div class="row gutter-xs q-pa-sm">
                                                <div class="item-form col-12">
                                                    <q-field :error="$v.fields.birthplace.value.$error"
                                                             error-label="Este campo es requerido"
                                                    >
                                                        <q-input v-model="fields.birthplace.value" clearable
                                                                 float-label="Lugar de Nacimiento *:"/>
                                                    </q-field>
                                                </div>
                                                <div class="item-form col-12">
                                                    <q-select
                                                            v-model="fields.education.value"
                                                            float-label="Nivel Educativo"
                                                            radio
                                                            :options="educationSelect"
                                                    />
                                                </div>
                                                <div class="item-form col-12">
                                                    <q-select
                                                            v-model="fields.civilStatus.value"
                                                            float-label="Nivel Educativo"
                                                            radio
                                                            :options="civilStatusSelect"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <q-tab-pane keep-alive name="address">
                                    <div class="row gutter-sm">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <p class="text-negative float-left q-mt-md" v-if="addressExist">Already
                                                Exist</p>
                                            <q-btn class="float-right q-mt-sm" color="primary" icon="add"
                                                   :label="addressEdit ? 'Save':'Add Address'" @click="addAddress"/>

                                            <q-btn class="float-left q-mt-sm" color="negative" label="Cancel"
                                                   @click="cancelAddress"
                                                   v-if="addressEdit"/>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <q-list highlight>
                                                ...
                                                <q-item separator v-for="(address, index) in form.addresses"
                                                        :key="index">

                                                    <q-item-main>
                                                        {{index+1}}. {{address.address1}} - {{address.state}} -
                                                        {{address.city}} -
                                                        {{address.zipCode}}
                                                    </q-item-main>
                                                    ...
                                                    <q-item-side right>
                                                        <q-btn round color="secondary" icon="edit"
                                                               @click="editAddress(address)" size="sm"
                                                               v-if="!addressEdit"/>
                                                        <q-btn round color="negative" icon="delete"
                                    ...
                                    <div class="row gutter-sm">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <q-field
                                                    ...
                                                    :count="10"
                                            >
                                                <q-input v-model="contact.firstName" type="text"
                                            ...
                                            <q-field
                                                    ...
                                                    :count="10"
                                            >
                                                <q-input v-model="contact.lastName" type="text"
                                            ...
                                            <q-field
                                                    ...
                                                    :count="10"
                                            >
                                                <q-input v-model="contact.cellularPhone" type="text"
                                            ...
                                            <p class="text-negative float-left q-mt-md" v-if="contactExist">Already
                                                Exist</p>
                                            <q-btn class="float-right q-mt-sm" color="primary" icon="add"
                                        ...
                                        <div class="col-12 col-md-6">
                                            <q-list highlight>
                                                ...
                                                <q-item separator v-for="(contact, index) in fields.contacts.value"
                                                        :key="index">
                                                    ...
                                                    <q-item-side right>
                                                        <q-btn round color="secondary" icon="edit"
                                                               @click="editContact(contact)" size="sm"
                                                               v-if="!contactEdit"/>
                                                        <q-btn round color="negative" icon="delete"
                                                               @click="deleteContact(contact)" size="sm"
                                                               class="q-ml-md"/>
                                                    </q-item-side>
                                                </q-item>
                                            </q-list>
                                ...
                                <q-tab-pane keep-alive name="socials">
                                    <div class="row gutter-sm">
                                        <div class="col-12 col-md-6">
                                            ...
                                            <p class="q-mt-md text-negative float-left" v-if="socialExist">Already
                                                Exist</p>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <q-list highlight>
                                                ...
                                                <q-item separator v-for="(social, index) in fields.socialNetworks.value"
                                                        :key="index">
                                                    ...
                                                    <q-item-side right>
                                                        <q-btn round color="secondary" icon="edit"
                                                               @click="editSocial(social)" size="sm"
                                                               v-if="!socialEdit"/>
                                                        <q-btn round color="negative" icon="delete"
                                                               @click="deleteSocial(social,index)" size="sm"
                                                               class="q-ml-md"/>
                                                    </q-item-side>
                                                </q-item>
                                            </q-list>
